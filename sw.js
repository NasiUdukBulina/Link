  ...
  event.waitUntil(
    caches.open(cacheKey).then((cache) => {
      ...
      return cache.addAll([
        ...
        "/{Link}/css/Font.css",
        "/{Link}/css/hero.css",
        "/{Link}/css/ScrollMouse.css",
        "/{Link}/css/wavestyle.css",
        "/{Link}/css/online-order.css",
        "/{Link}/css/navbar.css",
        "/{Link}/css/bahan-masakan.css",
        "/{Link}/css/menu-kami.css",
        "/{Link}/css/footer.css",
        "/{Link}/css/preload.css",

        "/{Link}/manifest.json",
        "/{Link}/main.js",
        "/{Link}/sw.js",
        "/{Link}/js/bootstrap.js",
        "/{Link}/js/owl-carousel-slider.js",
      ]);
    })
  );
});
